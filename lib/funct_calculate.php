...
function f_avg(&$array, &$f_cache) {
	if($f_cache['f_avg'] === FALSE) {
		$f_cache['f_avg'] = empty($array) ? REPORTIT_NAN : f_sum($array, $f_cache)/f_num($array, $f_cache);
	}
